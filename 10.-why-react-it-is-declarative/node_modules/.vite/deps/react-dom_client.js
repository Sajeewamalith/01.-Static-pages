import {
  require_react_dom
} from "./chunk-CDHNGL7L.js";
import {
  __commonJS,
  require_react
} from "./chunk-DF7LDYKJ.js";
  ...
  "node_modules/react-dom/cjs/react-dom-client.development.js"(exports) {
    ...
    (function() {
        ...
        if (6 === node.fiber.tag)
          ...
          if (void 0 === node.serverProps) {
            ...
            null === node.serverProps ? (debugInfo = describeExpandedElement(
              ...
              i,
              added(indent)
            ), indent++) : "string" === typeof node.serverProps ? error$jscomp$0(
      ...
      function validateDOMNesting(childTag, ancestorInfo) {
        ...
        ancestor = "<" + childTag + ">";
        parentInfo ? (parentInfo = "", "table" === ancestorInfo && "tr" === childTag && (parentInfo += " Add a <tbody>, <thead> or <tfoot> to your code to match the DOM tree generated by the browser."), error$jscomp$0(
      ...
      function validateTextNesting(childText, parentTag) {
        ...
        /\S/.test(childText) ? error$jscomp$0(
      ...
      function defaultOnCaughtError(error$1, errorInfo) {
        ...
        try {
          "object" === typeof error$1 && null !== error$1 && "string" === typeof error$1.environmentName ? printToConsole(
            "error",
            [
              "%o\n\n%s\n\n%s\n",
              error$1,
      ...
      function updateFunctionComponent(current2, workInProgress2, Component, nextProps, renderLanes2) {
        ...
        null === current2 && (validateFunctionComponentInDev(workInProgress2, workInProgress2.type), Component.contextTypes && (componentName2 = getComponentNameFromType(Component) || "Unknown", didWarnAboutContextTypes$1[componentName2] || (didWarnAboutContextTypes$1[componentName2] = true, error$jscomp$0(
      ...
      function updateClassComponent(current$jscomp$0, workInProgress2, Component, nextProps, renderLanes2) {
        ...
        if (null === workInProgress2.stateNode) {
          ...
          Component.childContextTypes && !didWarnAboutChildContextTypes.has(Component) && (didWarnAboutChildContextTypes.add(Component), error$jscomp$0(
            "%s uses the legacy childContextTypes API which was removed in React 19. Use React.createContext() instead. (https://react.dev/link/legacy-context)",
            state
          ));
          Component.contextTypes && !didWarnAboutContextTypes.has(Component) && (didWarnAboutContextTypes.add(Component), error$jscomp$0(
      ...
      function updateSuspenseComponent(current2, workInProgress2, renderLanes2) {
        ...
        var JSCompiler_object_inline_stack_2329 = workInProgress2.pendingProps;
        shouldSuspendImpl(workInProgress2) && (workInProgress2.flags |= 128);
        var JSCompiler_object_inline_componentStack_2330 = false;
        var didSuspend = 0 !== (workInProgress2.flags & 128);
        (JSCompiler_object_inline_digest_2328 = didSuspend) || (JSCompiler_object_inline_digest_2328 = null !== current2 && null === current2.memoizedState ? false : 0 !== (suspenseStackCursor.current & ForceSuspenseFallback));
        JSCompiler_object_inline_digest_2328 && (JSCompiler_object_inline_componentStack_2330 = true, workInProgress2.flags &= -129);
        JSCompiler_object_inline_digest_2328 = 0 !== (workInProgress2.flags & 32);
        workInProgress2.flags &= -33;
        if (null === current2) {
          if (isHydrating) {
            JSCompiler_object_inline_componentStack_2330 ? pushPrimaryTreeSuspenseHandler(workInProgress2) : reuseSuspenseHandlerOnStack(workInProgress2);
            if (isHydrating) {
            ...
            JSCompiler_object_inline_message_2327 = workInProgress2.memoizedState;
            if (null !== JSCompiler_object_inline_message_2327 && (JSCompiler_object_inline_message_2327 = JSCompiler_object_inline_message_2327.dehydrated, null !== JSCompiler_object_inline_message_2327))
              return JSCompiler_object_inline_message_2327.data === SUSPENSE_FALLBACK_START_DATA ? workInProgress2.lanes = DefaultHydrationLane : workInProgress2.lanes = OffscreenLane, null;
            popSuspenseHandler(workInProgress2);
          }
          JSCompiler_object_inline_message_2327 = JSCompiler_object_inline_stack_2329.children;
          JSCompiler_object_inline_stack_2329 = JSCompiler_object_inline_stack_2329.fallback;
          if (JSCompiler_object_inline_componentStack_2330)
            return reuseSuspenseHandlerOnStack(workInProgress2), JSCompiler_object_inline_componentStack_2330 = workInProgress2.mode, JSCompiler_object_inline_message_2327 = mountWorkInProgressOffscreenFiber(
              {
                mode: "hidden",
              ...
              renderLanes2,
              null
            ), JSCompiler_object_inline_message_2327.return = workInProgress2, JSCompiler_object_inline_stack_2329.return = workInProgress2, JSCompiler_object_inline_message_2327.sibling = JSCompiler_object_inline_stack_2329, workInProgress2.child = JSCompiler_object_inline_message_2327, JSCompiler_object_inline_componentStack_2330 = workInProgress2.child, JSCompiler_object_inline_componentStack_2330.memoizedState = mountSuspenseOffscreenState(renderLanes2), JSCompiler_object_inline_componentStack_2330.childLanes = getRemainingWorkInPrimaryTree(
              current2,
              JSCompiler_object_inline_digest_2328,
              renderLanes2
            ), workInProgress2.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2329;
        ...
        if (null !== prevState && (JSCompiler_object_inline_message_2327 = prevState.dehydrated, null !== JSCompiler_object_inline_message_2327)) {
          if (didSuspend)
            workInProgress2.flags & 256 ? (pushPrimaryTreeSuspenseHandler(workInProgress2), workInProgress2.flags &= -257, workInProgress2 = retrySuspenseComponentWithoutHydrating(
              ...
              workInProgress2,
              renderLanes2
            )) : null !== workInProgress2.memoizedState ? (reuseSuspenseHandlerOnStack(workInProgress2), workInProgress2.child = current2.child, workInProgress2.flags |= 128, workInProgress2 = null) : (reuseSuspenseHandlerOnStack(workInProgress2), JSCompiler_object_inline_componentStack_2330 = JSCompiler_object_inline_stack_2329.fallback, JSCompiler_object_inline_message_2327 = workInProgress2.mode, JSCompiler_object_inline_stack_2329 = mountWorkInProgressOffscreenFiber(
              {
                mode: "visible",
                children: JSCompiler_object_inline_stack_2329.children
              },
              JSCompiler_object_inline_message_2327
            ), JSCompiler_object_inline_componentStack_2330 = createFiberFromFragment(
              JSCompiler_object_inline_componentStack_2330,
              JSCompiler_object_inline_message_2327,
              renderLanes2,
              null
            ), JSCompiler_object_inline_componentStack_2330.flags |= 2, JSCompiler_object_inline_stack_2329.return = workInProgress2, JSCompiler_object_inline_componentStack_2330.return = workInProgress2, JSCompiler_object_inline_stack_2329.sibling = JSCompiler_object_inline_componentStack_2330, workInProgress2.child = JSCompiler_object_inline_stack_2329, reconcileChildFibers(
              workInProgress2,
              current2.child,
              null,
              renderLanes2
            ), JSCompiler_object_inline_stack_2329 = workInProgress2.child, JSCompiler_object_inline_stack_2329.memoizedState = mountSuspenseOffscreenState(renderLanes2), JSCompiler_object_inline_stack_2329.childLanes = getRemainingWorkInPrimaryTree(
              current2,
              JSCompiler_object_inline_digest_2328,
              renderLanes2
            ), workInProgress2.memoizedState = SUSPENDED_MARKER, workInProgress2 = JSCompiler_object_inline_componentStack_2330);
          else if (pushPrimaryTreeSuspenseHandler(workInProgress2), isHydrating && error$jscomp$0(
            "We should not be hydrating here. This is a bug in React. Please file a bug."
          ), JSCompiler_object_inline_message_2327.data === SUSPENSE_FALLBACK_START_DATA) {
            JSCompiler_object_inline_digest_2328 = JSCompiler_object_inline_message_2327.nextSibling && JSCompiler_object_inline_message_2327.nextSibling.dataset;
            ...
            JSCompiler_object_inline_componentStack_2330 = componentStack;
            JSCompiler_object_inline_message_2327 = JSCompiler_object_inline_message_2327 ? Error(JSCompiler_object_inline_message_2327) : Error(
              "The server could not finish this Suspense boundary, likely due to an error during server rendering. Switched to client rendering."
            );
            JSCompiler_object_inline_message_2327.stack = JSCompiler_object_inline_stack_2329 || "";
            JSCompiler_object_inline_message_2327.digest = JSCompiler_object_inline_digest_2328;
            JSCompiler_object_inline_digest_2328 = void 0 === JSCompiler_object_inline_componentStack_2330 ? null : JSCompiler_object_inline_componentStack_2330;
            "string" === typeof JSCompiler_object_inline_digest_2328 && CapturedStacks.set(
              JSCompiler_object_inline_message_2327,
              JSCompiler_object_inline_digest_2328
            );
            queueHydrationError({
              value: JSCompiler_object_inline_message_2327,
              source: null,
          ...
          } else if (JSCompiler_object_inline_digest_2328 = 0 !== (renderLanes2 & current2.childLanes), didReceiveUpdate || JSCompiler_object_inline_digest_2328) {
            JSCompiler_object_inline_digest_2328 = workInProgressRoot;
            if (null !== JSCompiler_object_inline_digest_2328) {
              JSCompiler_object_inline_stack_2329 = renderLanes2 & -renderLanes2;
              if (0 !== (JSCompiler_object_inline_stack_2329 & SyncUpdateLanes))
                JSCompiler_object_inline_stack_2329 = SyncHydrationLane;
              else
                switch (JSCompiler_object_inline_stack_2329) {
                  case SyncLane:
                    ...
                    break;
                  case InputContinuousLane:
                    JSCompiler_object_inline_stack_2329 = InputContinuousHydrationLane;
                    break;
                  case DefaultLane:
                    JSCompiler_object_inline_stack_2329 = DefaultHydrationLane;
                    break;
                  case 128:
                  case 256:
                  case 512:
                  ...
                  case 16777216:
                  case 33554432:
                    JSCompiler_object_inline_stack_2329 = TransitionHydrationLane;
                    break;
                  case IdleLane:
                    JSCompiler_object_inline_stack_2329 = IdleHydrationLane;
                    break;
                  default:
                    JSCompiler_object_inline_stack_2329 = 0;
                }
              JSCompiler_object_inline_stack_2329 = 0 !== (JSCompiler_object_inline_stack_2329 & (JSCompiler_object_inline_digest_2328.suspendedLanes | renderLanes2)) ? 0 : JSCompiler_object_inline_stack_2329;
              if (0 !== JSCompiler_object_inline_stack_2329 && JSCompiler_object_inline_stack_2329 !== prevState.retryLane)
                throw prevState.retryLane = JSCompiler_object_inline_stack_2329, enqueueConcurrentRenderForLane(
                  current2,
                  JSCompiler_object_inline_stack_2329
            ...
            JSCompiler_object_inline_message_2327.data === SUSPENSE_PENDING_START_DATA || renderDidSuspendDelayIfPossible();
            workInProgress2 = retrySuspenseComponentWithoutHydrating(
              current2,
              workInProgress2,
              renderLanes2
            ...
            JSCompiler_object_inline_message_2327.data === SUSPENSE_PENDING_START_DATA ? (workInProgress2.flags |= 128, workInProgress2.child = current2.child, workInProgress2 = retryDehydratedSuspenseBoundary.bind(
              null,
              current2
            ), JSCompiler_object_inline_message_2327._reactRetry = workInProgress2, workInProgress2 = null) : (current2 = prevState.treeContext, nextHydratableInstance = getNextHydratable(
        ...
        if (JSCompiler_object_inline_componentStack_2330)
          return reuseSuspenseHandlerOnStack(workInProgress2), JSCompiler_object_inline_componentStack_2330 = JSCompiler_object_inline_stack_2329.fallback, JSCompiler_object_inline_message_2327 = workInProgress2.mode, JSCompiler_temp = current2.child, instance = JSCompiler_temp.sibling, JSCompiler_object_inline_stack_2329 = createWorkInProgress(
            JSCompiler_temp,
            {
              mode: "hidden",
              children: JSCompiler_object_inline_stack_2329.children
            }
          ), JSCompiler_object_inline_stack_2329.subtreeFlags = JSCompiler_temp.subtreeFlags & 31457280, null !== instance ? JSCompiler_object_inline_componentStack_2330 = createWorkInProgress(
            instance,
            JSCompiler_object_inline_componentStack_2330
          ) : (JSCompiler_object_inline_componentStack_2330 = createFiberFromFragment(
            JSCompiler_object_inline_componentStack_2330,
            ...
            renderLanes2,
            null
          ), JSCompiler_object_inline_componentStack_2330.flags |= 2), JSCompiler_object_inline_componentStack_2330.return = workInProgress2, JSCompiler_object_inline_stack_2329.return = workInProgress2, JSCompiler_object_inline_stack_2329.sibling = JSCompiler_object_inline_componentStack_2330, workInProgress2.child = JSCompiler_object_inline_stack_2329, JSCompiler_object_inline_stack_2329 = JSCompiler_object_inline_componentStack_2330, JSCompiler_object_inline_componentStack_2330 = workInProgress2.child, JSCompiler_object_inline_message_2327 = current2.child.memoizedState, null === JSCompiler_object_inline_message_2327 ? JSCompiler_object_inline_message_2327 = mountSuspenseOffscreenState(renderLanes2) : (JSCompiler_temp = JSCompiler_object_inline_message_2327.cachePool, null !== JSCompiler_temp ? (instance = CacheContext._currentValue, JSCompiler_temp = JSCompiler_temp.parent !== instance ? { parent: instance, pool: instance } : JSCompiler_temp) : JSCompiler_temp = getSuspendedCache(), JSCompiler_object_inline_message_2327 = {
            baseLanes: JSCompiler_object_inline_message_2327.baseLanes | renderLanes2,
            cachePool: JSCompiler_temp
          }), JSCompiler_object_inline_componentStack_2330.memoizedState = JSCompiler_object_inline_message_2327, JSCompiler_object_inline_componentStack_2330.childLanes = getRemainingWorkInPrimaryTree(
            current2,
            JSCompiler_object_inline_digest_2328,
            renderLanes2
          ), workInProgress2.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2329;
        ...
        null !== current2 && (JSCompiler_object_inline_digest_2328 = workInProgress2.deletions, null === JSCompiler_object_inline_digest_2328 ? (workInProgress2.deletions = [current2], workInProgress2.flags |= 16) : JSCompiler_object_inline_digest_2328.push(current2));
      ...
      function printToConsole(methodName, args, badgeName) {
        ...
        "error" === methodName ? error$jscomp$0.apply(console, args) : "warn" === methodName ? warn.apply(console, args) : console[methodName].apply(console, args);
      }
